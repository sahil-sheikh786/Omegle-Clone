...
let createPeerConnection = async () => {
    ...
    sendChannel.onmessage = onReceiveChannelMessageCallback;
};
function sendData(){
...
function onReceiveChannelStateChange(){
    ...
    if(readyState==="open"){
        console.log("Data channel ready state is open - onReceiveStateChange");
    }else{
        console.log("Data channel ready state is not open - onReceiveStateChange");
    } 
};
...
function onSendChannelStateChange(){
    ...
    if(readyState === "open"){
        console.log("Data channel ready state is open - onSendDataChannel");
    }else{
        console.log("Data channel ready state is not open - onSendDataChannel");
    }
};
